...
public class ReportesController {
    ...
    public ModelAndView downloadFileReporteHorasICSExcel(@RequestParam(value="idSitio", required=false ) String idSitio,
     ...
     //   List<BhcEnvio> BhcEnviadas =  this.serologiaservice.getBhcEnvioByDates(nEnvios,dFechaInicio,dFechaFin);
        ...
        ReporteHorasLaboradas.addObject("sitios", sitios);
        ...
        ReporteHorasLaboradas.addObject("TipoReporte", Constants.TPR_ENVIOREPORTEBHC);
