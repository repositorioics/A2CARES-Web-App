package ni.org.ics.webapp.web.controller.corrections;
...
import ni.org.ics.webapp.web.utils.StringUtil;
...
public class CorregirTutorController {
    ...
    ResponseEntity<String> buscarParticipante(@RequestParam(value="parametro", required=true ) String codigo) throws ParseException {
        ...
        if (participante!=null) {
            ...
            MessageResource relFam = messageResourceService.getMensajeByCatalogAndCatKey("CAT_RF_TUTOR", participante.getRelacionFamiliarTutor());
    ...
    protected void save(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String codigoParticipante = jObjectRespuestas.get("codigoParticipante").getAsString();
            ...
            if (StringUtil.sonValoresDiferentes(nombre1ActTutor, nombre1NuevoTutor)) {
                ...
                listaCorrecciones.add(fillCorrection(claseParticipante, participante.getCodigo(), "NOMBRE1_TUTOR", nombre1ActTutor, nombre1NuevoTutor, observacion));
                listaCorrecciones.add(fillCorrection(claseCarta, cartaConsentimiento.getCodigo(), "NOMBRE1_TUTOR", nombre1ActTutor, nombre1NuevoTutor, observacion));
            ...
            if (StringUtil.sonValoresDiferentes(nombre2ActTutor, nombre2NuevoTutor)) {
                ...
                listaCorrecciones.add(fillCorrection(claseParticipante, participante.getCodigo(), "NOMBRE2_TUTOR", nombre2ActTutor, nombre2NuevoTutor, observacion));
            ...
            if (StringUtil.sonValoresDiferentes(apellido1ActTutor, apellido1NuevoTutor)) {
                ...
                listaCorrecciones.add(fillCorrection(claseParticipante, participante.getCodigo(), "APELLIDO1_TUTOR", apellido1ActTutor, apellido1NuevoTutor, observacion));
            ...
            if (StringUtil.sonValoresDiferentes(apellido2ActTutor, apellido2NuevoTutor)) {
                ...
                listaCorrecciones.add(fillCorrection(claseParticipante ,participante.getCodigo(), "APELLIDO2_TUTOR", apellido2ActTutor, apellido2NuevoTutor, observacion));
            ...
            if (StringUtil.sonValoresDiferentes(relacionFamAct, relacionFamNuevo)) {
                ...
                listaCorrecciones.add(fillCorrection(claseParticipante, participante.getCodigo(), "RELACION_FAMILIAR", relacionFamAct, relacionFamNuevo, observacion));
