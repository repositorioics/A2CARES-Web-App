...
@Controller
@RequestMapping("/asistenciaics/*")
public class ControlAsistenciaICSController {

    private static final Logger logger = LoggerFactory.getLogger(ControlAsistenciaICSController.class);
   ...
   @RequestMapping(value = "getcontrolAsistencia", method = RequestMethod.GET)
    public String controlIngresosMx(Model model) throws ParseException {
        logger.debug("Mostrando lista de control de asistencia ICS JSP");
