...
@Entity
@Table(name = "ColumnasDinamicasEnto", catalog = "a2cares", uniqueConstraints={@UniqueConstraint(columnNames = {"catRoot" , "catKey"})})
public class ColumnsDinamicasEnto implements Serializable, Auditable{
    ...
    public boolean equals(Object o) {
        ...
        ColumnsDinamicasEnto that = (ColumnsDinamicasEnto) o;
