                        ...
                        function (data) {
                            ...
                            if (data == 0) {
                                Swal.fire({
                                    ...
                                    text: "No se encontraron registro - Tabla Supervisor",
                                    icon: "info",
                                    timer: 4000
                                });
                            } else {
                    ...
                    $.getJSON(urls.getTablaEncuestador,
                        ...
                        function (data) {
                            ...
                            if (data == 0) {
                                Swal.fire({
                                    title: "¡Muestreo A2CARES!",
                                    text: "No se encontraron registro - Tabla Muestras (Encuestadores)",
                                    icon: "info",
                                    timer: 4000
                                });
                            } else {
                    ...
                    $.getJSON(urls.getTablaRecepcion,
                        ...
                        function (data) {
                            ...
                            if (data == 0) {
                                Swal.fire({
                                    title: "¡Muestreo A2CARES!",
                                    text: "No se encontraron registro - Tabla Serología Recepción",
                                    icon: "info",
                                    timer: 4000
                                });
                            } else {
