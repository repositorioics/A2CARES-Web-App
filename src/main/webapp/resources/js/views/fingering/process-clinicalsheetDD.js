    ...
    return {
        ...
        init: function (parametros) {
            ...
            function save() {
                ...
                swal.fire({
                    title: "A2CARES",
                    text: "Hoja guardada con éxito Digitación 2.",
                    type: "info",
                ...
                $.getJSON( parametros.searchUrl , formSearch.serialize() , function( data )   {
                        if (data.mensaje != undefined) {
                            ...
                            if (data.retirado != undefined)
                            {
                                swal.fire({
                                    title: "A2CARES",
                                    text: "Participante Retirado, confirmar Doble ditigación",
                                    type: "warning",
                                    showCancelButton: true,
                                    confirmButtonText: "Confirmar Doble Digitación",
                                    cancelButtonText: "Cancelar",
