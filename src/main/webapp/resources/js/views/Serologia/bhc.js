    ...
    return{
        init: function(urls){
            ...
            function searchParticipante(){
                ...
                var part = $('#parametro').val();
                if (part.length > 4){

                    part = $('#parametro').val().substring(3,7);
                }


                $.getJSON(endPointSero.searchPartUrl, { parametro : part,   ajax : 'true'  }, function(data) {
                    var len = data.length;
