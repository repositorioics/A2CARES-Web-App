                ...
                $.getJSON(urls.MxNoEnviadasUrl, function(data){
                    ...
                    if(data==0){
                        ...
                        for ( var i = 0; i < len; i++) {
                            ...
                            var btnPasive  = '<button type="button" id="btnPasive" data-toggle="tooltip" data-placement="bottom" title="Eliminar"  class="btn btn-danger btn-sm btnPasive" data-id='+ data[i].idbhc + '> <i class="fas fa-trash" aria-hidden="true"></i>  </button>';
                            table.row.add([
                                data[i].idbhc,
                                data[i].fecha,
                                data[i].participante,
