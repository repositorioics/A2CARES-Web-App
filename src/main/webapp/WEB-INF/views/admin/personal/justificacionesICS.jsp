    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/movil/getJustificaionesICS" htmlEscape="true "/>"></a>
            </li>
        </ol>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h5 class="page-title">
                    <i class="fa fa-list-alt"></i>&nbsp;<strong><spring:message code="Justificaciones" /></strong>
                    </h5>
                </div>
            ...
            <div class="card">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <table id="Lista_asistencia" class="table table-hover table-bordered" width="100%">
                        <thead>
                        <tr>
                            <th id="nombre_usuario"><spring:message code="IdUser"/></th>
                            <th id="nombre_completo"><spring:message code="Id Tipo Justificación"/></th>
                            <th id="horaentrada"><spring:message code="Descripción Justificación"/></th>
                            <th id="fechaasistencia"><spring:message code="Fecha Inicio"/></th>
                            <th id="Cargo"><spring:message code="Fecha Fin"/></th>
...
<spring:url value="/movil/getJustificaionesICS" var="getJustificaionesICS"/>
...
jQuery(document).ready(function() {
    ...
    var table = $('#Lista_asistencia').DataTable({
        ...
        "ajax":{
            url: "${getJustificaionesICS}", // Change this URL to where your json data comes from
            type: "GET",
            data: function(d) {
        ...
        "columns": [
            ...
            { data: 'idUsr', defaultContent: ""},
            { data: 'idTipoJustificacion', defaultContent: ""},
            { data: 'descripcionJust', defaultContent: ""},
