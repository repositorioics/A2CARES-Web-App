                           ...
                           <div class="card-block">
                               <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    <div class="input-group col-lg-3 col-md-3 col-sm-4">
                                        <div class="form-group">
                                    ...
                                    <div id="BuscarEmpleado" class="col-md-12">
                                        <div class="p-2 bd-highlight">
                                            <button id="searchClinicalSheet" class="btn btn-info btn-ladda" type="submit">
...
jQuery(document).ready(function() {
    ...
    $("#toExcel").on("click", function(){
        var $validarForm = formSearch.valid();
        if (!$validarForm) {
            $validator.focusInvalid();
            return false;
        } else {
            window.open("${excelReporteHorasIcs}?" + formSearch.serialize())
        }
    });
