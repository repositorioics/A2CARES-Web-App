    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/movil/getAsistenciaPersonalICS" htmlEscape="true "/>"></a>
            </li>
        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <table id="Lista_asistencia" class="table table-hover table-bordered" width="100%">
                        ...
                        <tr>
                            ...
                            <th id="Area"><spring:message code="Sitio"/></th>
                            <th id="AreaMarcaje"><spring:message code="Sitio Marcación"/></th>
