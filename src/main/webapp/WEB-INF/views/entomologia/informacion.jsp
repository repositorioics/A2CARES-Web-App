    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <a href="<spring:url value="/cartas/informacion" htmlEscape="true "/>"><spring:message code="Information" /></a>
            </li>
        </ol>
                            ...
                            <form autocomplete="off" id="search-participant-form" class="form-horizontal">
                                ...
                                <div class="form-actions fluid">
                                    <div class="col-md-offset-6 col-md-10">
                                        <button id="toPdf" type="submit" class="btn btn-success btn-ladda" data-style="expand-right"><spring:message code="generate" /> <spring:message code="Information" /> <i class="fa fa-file-excel-o"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
