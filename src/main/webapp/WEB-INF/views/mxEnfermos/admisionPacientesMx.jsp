    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/mx/enfermo/getAdmisionPacientes" htmlEscape="true "/>"></a>
            </li>
        </ol>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h5 class="page-title">
                    <i class="fa fa-list-alt"></i>&nbsp;<strong><spring:message code="Admisión Pacientes - Puestos" /></strong>
                    </h5>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <table id="Lista_Admision_Pacientes" class="table table-hover table-bordered" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="text-center"><spring:message code="Fecha de Registro" /></th>
                            <th  class="text-center"><spring:message code="Numero Hoja" /></th>
                            <th  class="text-center"><spring:message code="Pertenece Estudio" /></th>
                            <th  class="text-center"><spring:message code="Código Participante" /></th>
                            <th  class="text-center"><spring:message code="Febril" /></th>
                            <th  class="text-center"><spring:message code="Sexo" /></th>
                            <th  class="text-center"><spring:message code="Edad" /></th>
                            <th  class="text-center"><spring:message code="Usuario Registro" /></th>
...
<spring:url value="/mx/enfermo/getAdmisionPacientes" var="getAdmisionPacientes"/>
...
jQuery(document).ready(function() {
    ...
    var table = $('#Lista_Admision_Pacientes').DataTable({
        ...
        "ajax":{
            url: "${getAdmisionPacientes}", // Change this URL to where your json data comes from
            type: "GET",
            data: function(d) {
        ...
        "columns": [
            ...
            { data: 'numeroHoja', defaultContent: ""},
            { data: 'perteneceEstudio', defaultContent: ""},
            { data: 'codigoParticipante', defaultContent: ""},
            { data: 'febril', defaultContent: ""},
