    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/mx/enfermo/informeFinDiaMedicosMx" htmlEscape="true "/>"></a>
            </li>
        </ol>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <hr/>
                    <table id="Lista_Informe_Fin_Dia" class="table table-hover table-bordered" width="100%">
                        <thead>
                        <tr>
                            ...
                            <th  class="text-center"><spring:message code="Diagnósticos y números de hoja PCohorte" /></th>
...
jQuery(document).ready(function() {
    ...
    var table = $('#Lista_Informe_Fin_Dia').DataTable({
        ...
        "columns": [
            ...
            { data: 'diagnosNumHoja', defaultContent: ""},
