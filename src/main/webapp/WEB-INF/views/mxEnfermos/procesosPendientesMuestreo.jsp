    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/mx/enfermo/getProcesosPendientesMuestreo" htmlEscape="true "/>"></a>
            </li>
        </ol>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h5 class="page-title">
                    <i class="fa fa-list-alt"></i>&nbsp;<strong><spring:message code="Estado de Procesos - Muestreo A2CARES" /></strong>
                    </h5>
                </div>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <hr/>
                    <table id="Lista_Admision_Pacientes" class="table table-hover table-bordered" width="100%">
                        <thead>
                        <tr>

                            <th class="text-center"><spring:message code="Casa" /></th>
                            <th  class="text-center"><spring:message code="Participante" /></th>
                            <th  class="text-center"><spring:message code="Sector" /></th>
                            <th  class="text-center"><spring:message code="Barrio" /></th>
                            <th  class="text-center"><spring:message code="Enc_Part" /></th>
                            <th  class="text-center"><spring:message code="Enc_Casa" /></th>
                            <th  class="text-center"><spring:message code="PyT" /></th>
                            <th  class="text-center"><spring:message code="Enc_Satis" /></th>
                            <th  class="text-center"><spring:message code="Obsequio" /></th>
                            <th  class="text-center"><spring:message code="Mx" /></th>
                            <th  class="text-center"><spring:message code="Conv" /></th>
...
<spring:url value="/mx/enfermo/getProcesosPendientesMuestreo" var="getProcesosPendientesMuestreo"/>
...
jQuery(document).ready(function() {
    ...
    var table = $('#Lista_Admision_Pacientes').DataTable({
        ...
        "ajax":{
            url: "${getProcesosPendientesMuestreo}", // Change this URL to where your json data comes from
            type: "GET",
            data: function(d) {
        ...
        "columns": [
            ...
            { data: 'codigo_casa', defaultContent: ""},
            { data: 'codigo', defaultContent: ""},
            { data: 'sector', defaultContent: ""},
            { data: 'barrio', defaultContent: ""},
            { data: 'enc_part', defaultContent: ""},
            { data: 'enc_casa', defaultContent: ""},
            { data: 'pyt', defaultContent: ""},
            { data: 'enc_satis', defaultContent: ""},
            { data: 'obsequio', defaultContent: ""},
            { data: 'mx', defaultContent: ""},
            { data: 'conv', defaultContent: ""}
