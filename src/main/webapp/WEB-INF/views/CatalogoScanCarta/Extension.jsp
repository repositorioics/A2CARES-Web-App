        ...
        <div class="container-fluid">
            ...
            <div class="row p-4 no-gutters align-items-center">
                ...
                <form id="frmExtension" name="frmExtension" autocomplete="off">
                    <spring:url value="/CatalogoVersion/desactActivarExtension" var="desactActivarExtensionUrl"/>
                    <spring:url value="/CatalogoVersion/activarExtension" var="activarExtensionUrl"/>
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><i class="fas fa-calendar-alt text-info"></i></span>
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend2"> <i class="fab fa-etsy text-info"></i></span>
                                </div>
               ...
               <div>
                   <div class="table-responsive">
                       <table  id="tblExtension" class="table table-hover table-bordered">
                           ...
                           <tbody>
                            <c:forEach items="${listAllExtensiones}" var="e">
                                <spring:url value="/CatalogoVersion/editExtension/{idextension}" var="editUrl">
                                       ...
                                       <sec:authorize access="hasRole('ROLE_WEB')">
                                           <td class="text-center">
                                               ...
                                               <c:choose>
                                                   ...
                                                   <c:otherwise>
                                                       <button class="btn btn-danger btn-sm activar"><i class="fa fa-lock"></i></button>
                                                   </c:otherwise>
                                               </c:choose>
                                           </td>
                                       </sec:authorize>
...
<script>
    $(document).ready(function(){
        ...
        var parametros = {
            ...
            desactActivarExtensionUrl :"${desactActivarExtensionUrl}",
            activarExtensionUrl:"${activarExtensionUrl}"
        };
        ...
        $("#tblExtension tbody").on("click", ".desact", function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    $.post(parametros.desactActivarExtensionUrl, { idextension: column01, ajax: 'true' }).done(function (data) {
        ...
        $("#tblExtension tbody").on("click", ".activar", function(){
            var currentRow = $(this).closest("tr");
            var column01 = table.row(currentRow).data()[0];
            var column02 = table.row(currentRow).data()[2];
            var column03 = table.row(currentRow).data()[3];
            ...
            swal({
                ...
                if (isConfirm) {
                    $.post(parametros.activarExtensionUrl, { idextension: column01, ajax: 'true' }).done(function (data) {
