...
<div class="card-body bg-primary text-white mailbox-widget pb-0">
    <h2 class="text-white pb-3" style="font-family: Roboto, sans-serif"><spring:message code="version"/></h2>
                    ...
                    <div class="container">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupPrepend1"><i class="fab fa-vimeo-v text-info"></i></span>
                                    </div>
    ...
    $(document).ready(function () {
        ...
        function SaveVersion(dir) {
            $.post(dir.saveVersionUrl, formV.serialize(), function (data) {
                ...
                toastr.error("Interno en el Servisor.","Error!",{timeOut:6000});
            });
        }
        ...
        function saveExtensionModal(dir){
            $.post(dir.saveExtUrl, formExtModal.serialize(), function (data) {
                if (data.msj != null) {
                    toastr.warning( data.msj, "ADVERTENSIA!",{timeOut:6000});
                } else {
                    toastr.success(dir.successmessage);
                    window.setTimeout(function () {
                        window.location.href = parameters.ListadoVersionUrl;
