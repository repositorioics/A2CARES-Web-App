        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <a href="<spring:url value="/CatalogoParte/CrearNuevaParte/" htmlEscape="true "/>">
                    <spring:message code="lbl.To.assign" /> <spring:message code="lbl.Parts" />
                </a>
            </li>
        </ol>
        <div class="container-fluid">
            <div class="animated fadeIn">
                ...
                <div class="card-body bg-primary text-white mailbox-widget pb-0">
                    <h2 class="text-white pb-3"><spring:message code="lbl.To.assign"/> <spring:message code="lbl.Parts"/></h2>
