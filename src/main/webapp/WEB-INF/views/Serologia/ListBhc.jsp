    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/Serologia/listBhc/" htmlEscape="true "/>"><spring:message code="List" /> <spring:message code="BHC" /></a>
            </li>
        </ol>
        ...
        <spring:url value="/Serologia/editMuestraBhc" var="editUrl"/>
        <spring:url value="/Serologia/enviarMuestraBhc" var="envioUrl"/>
        <spring:url value="/Serologia/sendAllBhc" var="sendAllBhc"/>
        <spring:url value="/Serologia/closeCase" var="closeUrl"/>
        <spring:url value="/Serologia/listBhc" var="listSerologiaUrl"/>

        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-list-alt"></i> <spring:message code="Biometrias" />
                </div>
                <div class="card-block">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="<spring:url value="/Serologia/createBhc" htmlEscape="true"/>" class="btn btn-success btn-lg">
                                <i class="fa fa-plus" aria-hidden="true"></i> <spring:message code="lbl.new" /> <spring:message code="Muestras BHC" />  </a>
                        </div>
                    </div>
                    <hr/>
                    <div class="container">
...
<spring:url value="/resources/js/views/Serologia/ListBhc.js" var="SeroJs" />
