    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/Serologia/listBhc" htmlEscape="true "/>"><spring:message code="Reporte Envio" /></a>
            </li>
        </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <form autocomplete="off" id="search-participant-form" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="form-control-label col-md-3" for="fechaInicio"><spring:message code="Fecha Inicio" /></label>
                                ...
                                <div class="form-group row">
                                    <label class="form-control-label col-md-3" for="fechaFin"><spring:message code="Fecha Final" /> </label>
