...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="page-title">
                            <i class="fa fa-database"></i>&nbsp;<strong><spring:message code="Imprimir BHC Importadas - Bc6000" /></strong>
                        </h3>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control date-picker" id="fechaFinCons"  value="${fecha}"  name="fechaFinCons" placeholder="<spring:message code="fecha_holder" />"/>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <label class="form-control-label" for="participante"><spring:message code="Código Participante:" />
                                    </label>
                                    <div class="form-group">
                                        <input type="text" class="form-control fa-sort-numeric-asc" id="participante"  name="participante" placeholder="<spring:message code="código participante" />"/>
                    ...
                    <div class="row no-gutters row-bordered">
                        <div class="col-md-12 col-lg-12 col-xl-12" >
                            ...
                            <div  class="card-body" >
                                ...
                                <div  class="row"   style="width:1600px; height:900px; overflow-x:scroll ; padding-bottom:10px;">
                                <table id="lista_hojas1" class="table table-condensed table-bordered table-hover" >
                                <thead>
                                <tr>
                                    <th><spring:message code="Impimir BHC"/></th>
                                    <th><spring:message code="BHC_ID"/></th>
                                <th><spring:message code="Código_Participante"/></th>
                                <th><spring:message code="Fecha Procesada"/></th>
                                <th><spring:message code="Hora Procesada"/></th>
                                <th><spring:message code="Impreso"/></th>
    ...
    <spring:url value="/hojaclinica/getBHCImportadaBc6000" var="getBHCImportadaBc6000"/>
    <spring:url value="/reportes/ReporteBhcBc6000/"
                var="printUrl"/>
    ...
    jQuery(document).ready(function() {
      ...
      //  $("#nEnvios").val("${numEnvio}");
        ...
        var table = $('#lista_hojas1').DataTable({
            ...
            "ajax":{
                url: "${getBHCImportadaBc6000}", // Change this URL to where your json data comes from
                type: "GET",
                data: function(d) {
                    d.fechaInicioCons = $("#fechaInicioCons").val();
                    d.fechaFinCons = $("#fechaFinCons").val();
                    d.participante = $("#participante").val();
                    d.bhcId =0;
                },
                dataSrc: ""
            ...
            "columns": [
                 { data: 'Corrección', defaultContent: "",
                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                        var editUrl =  '/a2cares/reportes/ReporteBhcBc6000/' + oData.participante_cod + '/'+ oData.idbhc + '/';
                        //    var editUrln =  '/a2cares/hojaclinica/editarBHC1/' + oData.participante + '/'+ oData.idbhc + '/'+ oData.fecha + '/'+ oData.numEnvio + '/';
                        // editUrl = 'editarHC/';
                        if (oData.idbhc != null) {
                           // window.open($(nTd).html('<a data-toggle="tooltip" data-placement="bottom" title= ' + edithojas + ' href=' + editUrl + ' class="btn btn-success btn-sm" target="_blank"><i class="fa fa-file-pdf"></i></a> '), '_blank');
                            $(nTd).html('<a data-toggle="tooltip" data-placement="bottom" title= ' + edithojas + ' href=' + editUrl + ' class="btn btn-secondary" target="_blank"><i class="fa fa-file-pdf" aria-hidden="true""></i></a> ');
                        }
                        ...
                        //$(nTd).html('<a data-toggle="tooltip" data-placement="bottom" title= ' + editUrl + ' href=' + editUrl + ' class="btn btn-outline-primary btn-sm"><i class="fa fa-file-pdf"></i></a> ');
                    //    $(nTd).html('<a data-toggle="tooltip" data-placement="bottom" title= ' + edithojas + ' href=' + editUrl + ' class="btn btn-danger btn-sm"><i class="fa fa-edit"></i></a> ');
                    }

                },

                { data: 'idbhc', defaultContent: ""},
                { data: 'participante_cod', defaultContent: ""},
                { data: 'fecha', defaultContent: ""},
                { data: 'hora', defaultContent: ""},
                { data: 'impreso', defaultContent: ""},
