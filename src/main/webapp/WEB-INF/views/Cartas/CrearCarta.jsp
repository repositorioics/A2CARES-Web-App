...
<div class="card-header">
    <h5 style="font-family: Roboto">
        <i class="fas fa-user-tag"></i> <spring:message code="lbl.To.assign"/> <spring:message code="letters"/>
    </h5>
</div>
...
<div class="row">
<div class="col-sm-12">
    <a class="btn btn-outline-primary btn-lg" data-toggle="tooltip" data-placement="bottom" title="Volver al Listado"
    ...
    <div class="card-header" id="headingOne">
        <h2 class="clearfix mb-0">
            <a id="one" class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                <i class="fa fa-plus-circle"></i> <spring:message code="Information"/> <spring:message code="lbl.participant"/></a>
        </h2>
    </div>
                    ...
                    <div class="container">
                        <form action="#" autocomplete="off" id="select-participante-form" name="select-participante-form" class="form-horizontal">
                            <div class="form-group row">
                                <label class="form-control-label col-md-2 text-right" for="username"><spring:message code="lbl.participant" />
                                    <span class="required">*</span>
                                </label>
                                <div class="input-group col-md-10">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input id="parametro" name="parametro" type="text" value="" class="form-control"/>
                                    <button id="buscar" type="submit" class="btn btn-primary btn-ladda" data-style="expand-right">
                    ...
                    <hr/>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="txtNombreCompleto"><spring:message code="entityName" /> :</label>
                                <input type="text" class="form-control form-control-sm" id="txtNombreCompleto" name="txtNombreCompleto" disabled>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="edadyear"><spring:message code="lbl.age"/> <spring:message code="lbl.years"/></label>
                                <input type="text" class="form-control form-control-sm" id="edadyear" name="edadyear" disabled>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="edadmeses"><spring:message code="lbl.age"/> <spring:message code="lbl.mounths"/></label>
                                <input type="text" class="form-control form-control-sm" id="edadmeses" name="edadmeses" disabled>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="edaddias"><spring:message code="lbl.age"/> <spring:message code="lbl.days"/></label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="estudios"><spring:message code="lbl.study"/> :</label>
                                <input type="text" class="form-control form-control-sm" id="estudios" name="estudios" value="A2CARE" readonly style="cursor: not-allowed;">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="relacionFam"><spring:message code="family.relationship"/></label>
...
<div class="card">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
        <div class="card-body">
            <div class="media">
                <div class="media-body">
                    <form id="form-scan" autocomplete="off" class="needs-validation" novalidate>
                    <div class="row">
                        <div class="col-md-6" >
                        ...
                        <div class="form-group col-md-2">
                            <label> <spring:message code="code" /> <spring:message code="participant" />:</label>
                            <input type="text" class="form-control" name="codigo" id="codigo" readonly required="required" style="cursor: not-allowed;"/>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="carta" id="carta" name="carta" class="form-control" required="required">
                                    ...
                                    <c:forEach items="${carta}" var="e">
                                        <option value="${e.codigo}">${e.codigo} - ${e.nombre}</option>
                                    </c:forEach>
                                </select>
                                <span class="error"> <spring:message code="letters" /> <spring:message code="lbl.required" /></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="error"><spring:message code="lbl.version.letter" /> <spring:message code="lbl.required" /></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="required text-danger"> * </span>
                                <input type="text" class="form-control onlytext" id="nombfirma" name="nombfirma" required="required" value="${obj.name1Tutor}"/>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control onlytext" id="nombre2Firma" name="nombre2Firma"  value="${obj.name2Tutor}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="required text-danger"> * </span>
                                <input type="text" class="form-control onlytext" id="apellido1Firma" required="required" name="apellido1Firma" value="${obj.surname1Tutor}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control onlytext" id="apellido2Firma" name="apellido2Firma"  value="${obj.surname2Tutor}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="error"><spring:message code="family.relationship" /> <spring:message code="lbl.required" /></span>
                            </div>
                        </div>
                        <%--  tutor fin--%>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="fechacarta"><spring:message code="fecha" /></label>
                                <span class="required text-danger"> * </span>
                                <input type="text" class="form-control" required="required" name="fechacarta" id="fechacarta" data-date-end-date="+0d"/>
                                <span class="error"><spring:message code="lbl.date" /> <spring:message code="lbl.required" /></span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="error"><spring:message code="lbl.project" /> <spring:message code="lbl.required" />.</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="error"><spring:message code="lbl.resource"/> <spring:message code="lbl.required" /></span>
                            </div>
                        </div>
                    </div><!-- fin row -->
                        <div class="row">
                            ...
                            <div class="col-md-3"  id="divAsentimiento">
                                <div class="form-group">
                            ...
                            <div class="col-md-3" id="divTipoAsentimiento">
                                <div id="DivtipoAsent">
                                    <div class="form-group">
