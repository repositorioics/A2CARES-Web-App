...
<div class="row" hidden="hidden">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="idParticipanteCarta" name="idParticipanteCarta"
                   value="${objParticipanteCarta.idparticipantecarta}">
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="idVersion" name="idVersion"
                   value="${objParticipanteCarta.version.idversion}">
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="idParticipante" name="idParticipante"
                   value="${objParticipanteCarta.participante.codigo}">
        </div>
    </div>
    ...
    <div class="form-group col-md-2">
        <label for="codigo_participante"><spring:message code="participant.code" /></label>
        <input type="text" class="form-control" id="codigo_participante" name="codigo_participante" value="${objParticipanteCarta.participante.codigo}" readonly>
    </div>
    ...
    <div class="form-group col-md-10">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" id="nombreCompleto" name="nombreCompleto" value="${nombreCompleto}" readonly>

        </div>
    </div>

    <div class="form-group col-md-4">
        <label for="estudio"><spring:message code="Estudio" /></label>
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="version" name="version" value="${objParticipanteCarta.version.version}" readonly>
    </div>
    <div class="form-group col-md-4">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" required="required" name="fechaExtension"
                   id="fechaExtension" data-date-end-date="+0d"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <span class="required text-danger"> * </span>
            <input type="text" class="form-control focusNext" tabindex="1" id="nombre1tutor" name="nombre1tutor"
                   value="${caso.nombre1Tutor}" required/>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <label for="nombre2tutor"><spring:message code="2do. Nombre Tutor:" />:</label>
            <input type="text" class="form-control focusNext" tabindex="2" id="nombre2tutor" name="nombre2tutor"
                   value="${caso.nombre2Tutor}">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            ...
            <span class="required text-danger"> * </span>
            <input type="text" class="form-control focusNext" tabindex="3" id="apellido1tutor" required
                   name="apellido1tutor" value="${caso.apellido1Tutor}">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <label for="apellido2tutor"><spring:message code="2do. Apellido Tutor:" />:</label>
            <input type="text" class="form-control focusNext" tabindex="4" id="apellido2tutor"
                   name="apellido2tutor" value="${caso.apellido2Tutor}">
        </div>
    </div>
...
<div id="showDivTestigo" style="display: none">
    <div class="card w-100">
        <div class="card-body">
            <h5 class="card-title">Datos del Testigo</h5>
