                                ...
                                <c:forEach items="${listExtensiones}" var="e" varStatus="theCount">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="<spring:message code="edit" />" href="${fn:escapeXml(editExtensionUrl)}" class="btn btn-outline-primary btn-sm">
                                                <i class="fas fa-user-edit" aria-hidden="true"></i> </a>

                                            <a title="<spring:message code="disable" />" data-toggle="modal" class="btn btn-danger btn-sm desact">
                                                <i class="fas fa-user-times text-white" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
