            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="card bg-white rounded bg-white text-black-50" >
                            <div class="card-header">
                                <h5><i class="fas fa-mail-bulk"></i>
                                    <spring:message code="letters" /> <spring:message code="lbl.participant" />
                                </h5>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="p-2 bd-highlight">
                                        <a class="btn btn-outline-primary btn-lg" data-toggle="tooltip" data-placement="bottom" title="Asignar Carta" href="<spring:url value="/cartas/Crear" htmlEscape="true "/>">
                                    ...
                                    <div class="p-2 bd-highlight">
                                        <a class="btn btn-outline-info btn-lg" data-toggle="tooltip" data-placement="bottom" title="<spring:message code="List" />
                                        <spring:message code="Extension" />" href="<spring:url value="/cartas/ListExtension" htmlEscape="true "/>">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-lg-8">
                                        <form action="#" autocomplete="off" id="select-participante-form" class="form-horizontal">
                                            <div class="form-group row">
                                                <label class="form-control-label col-md-3 mt-2" for="username"><spring:message code="participant.code" />
                                                ...
                                                <div class="input-group col-md-9">
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="parametro" name="parametro"  aria-describedby="button-addon2">
                                                        <div class="input-group-append">
                                                            <button class="btn btn-primary btn-ladda" data-style="expand-right" id="buscar" type="submit">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger float-left" data-dismiss="modal">
                            ...
                            <spring:message code="lbl.close" /></button></button>
...
<sec:authorize access="hasAnyRole('ROLE_SUPER')" var="isAuthorizeAny"></sec:authorize> <!-- permiso para anular carta -->
<sec:authorize access="hasRole('ROLE_ADMIN')" var="haRoleAdmin"></sec:authorize>
