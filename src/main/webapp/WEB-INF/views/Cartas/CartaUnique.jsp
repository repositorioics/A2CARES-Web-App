...
<div class="card-header">
    <h3 style="font-family: Roboto, sans-serif">
        ...
        <spring:message code="letters"/></h3>
</div>
<div class="card-body">
    <div class="col-md-12">
        <a class="btn btn-info btn-lg" data-toggle="tooltip" data-placement="bottom"
           title="<spring:message code="Form"/> <spring:message code="letters" />" href="<spring:url value="/cartas/Crear" htmlEscape="true "/>">
...
<div class="table-responsive" style="min-height: 450px;">
    <table id="tblSaved" class="table table-hover table-bordered table-striped">
        <thead>
        <tr>
            <th class="text-center" width="10%"><spring:message code="lbl.participant"/></th>
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a title="<spring:message code="edit" />" href="${fn:escapeXml(EditCartaUrl)}"
                           class="dropdown-item">
                            <i class="fas fa-user-edit text-warning"></i> <spring:message code="edit"/>
                        </a>
