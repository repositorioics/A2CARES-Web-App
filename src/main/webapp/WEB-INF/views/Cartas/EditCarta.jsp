                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="">
                                  <div class="row">
                                  <div class="col-sm-12">
                                      <a class="btn btn-outline-primary btn-lg" data-toggle="tooltip" data-placement="bottom" title="Volvel al Listado"
                                                        ...
                                                        <div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>idparticipantecarta:</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control form-control-sm" id="estudios" name="estudios" value="${estudio}" disabled>
                                                            </div>
                                                        </div>
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <div class="media">
                                                ...
                                                <form action="#" id="form-scan"  autocomplete="off" class="needs-validation" novalidate role="form" data-toggle="validator" method="post" accept-charset="utf-8">
                                                <div class="row">
                                                <div class="col-md-12"></div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for="idparticipante"> <spring:message code="participant.code" />: </label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="required text-danger"> * </span>
                                                        <input type="text" class="form-control onlytext" id="nombfirma" name="nombfirma" value="${obj.quienfirma}" required="required"/>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="required text-danger"> * </span>
                                                        <input type="text" class="form-control onlytext" id="apellido1Firma" name="apellido1Firma" value="${obj.apellido1Firma}" required="required">
                                                        <div class="invalid-feedback">
                                                ...
                                                <div id="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <button type="submit" id="btnUpdate" class="btn btn-info btn-block btn-lg">
...
<script>
     ...
     */
        ...
        function ValidateForm() {
            ...
            var status = ($("#chktestigo").is(':checked')) ? 'checked' : 'unchecked';
            if(status== 'checked' && $("#nombre1Testigo").val()==""){
                isAllValid = false;
                $('#nombre1Testigo').removeClass('is-invalid');
                $('#nombre1Testigo').addClass('is-invalid');
            } else{
                $('#nombre1Testigo').removeClass('is-invalid');
            }
            if(status=='checked' && $("#apellido1Testigo").val()==""){
                isAllValid = false;
                $('#apellido1Testigo').removeClass('is-invalid');
                $('#apellido1Testigo').addClass('is-invalid');
            }else{
                $('#apellido1Testigo').removeClass('is-invalid');
            }
            ...
            $.ajax({
                ...
                success: function(d){
                    ...
                    window.setTimeout(function(){
                        window.location.href = parametros.cartaSaveEditUrl+"/"+d.idparticipantecarta;
                    }, 1500);
        ...
        $("#chktestigo").on("click", function(){
            ...
            if(status == 'checked'){
                ...
                $("#apellido1Testigo").attr("required", "false");
            }else{
