        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-list-alt"></i> <spring:message code="Resultados carga archivo CSV Asistencia Reloj ICS" />
                </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="import-results col-md-12 col-lg-12 col-xl-12">
                                        <strong><spring:message code="Resumen de Carga de Registros Nuevos a Tabla en Umich:" arguments="${nuevos}" htmlEscape="false"/></strong>
                                        <table id="lista_entidades" class="table table-striped table-bordered datatable" width="100%">
                                            <thead>
                                            <tr>
                                                <th><spring:message code="Id " /></th>
                                                <th><spring:message code="Fecha-Hora asistencia" /></th>
                                                <th><spring:message code="Tipo Asistencia" /></th>
                                            </tr>
                                            </thead>
                                            <tbody>
