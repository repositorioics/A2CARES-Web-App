...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        ...
        <i class="fa fa-angle-right"></i> <a href="<spring:url value="/hojaclinicaDD/" htmlEscape="true "/>"><spring:message code="Hola Clínica - Edición" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/hojaclinicaDD/add" htmlEscape="true "/>"><spring:message code="add" /></a>
    </li>
</ol>
...
<div class="card-header">
    <h3 class="page-title">
        <spring:message code="Hola Clínica - Edición" /> <small><spring:message code="" /></small>
    </h3>
</div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-lg-4 col-md-12 col-sm-12">
                        ...
                        <input id="participantCode" name="participantCode" type="text" readonly  class="form-control" value="${codigo_participante1}" placeholder="<spring:message code="search_participant_holder" />" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fechanac" name="fechanac"
                               value="${fechaNac}" readonly />
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="form-group">
                        <label for="edadPart"><spring:message code="edad" /></label>
                        <input type="text" class="form-control" id="edadPart" name="edadPart" value="${edad}" readonly />
                    </div>
                ...
                <div class="col-lg-1 col-md-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sexoPart" required name="sexoPart" value="${sexo}" readonly />
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group"  align="center">
                  ...
                  <span class="input-group-addon" >
                    ...
                    <input type="text" id="codigoSupervisor" required  name="codigoSupervisor" value="${codigo_supervisor1}"   />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="form-group">
            ...
            <span class="input-group-addon">
                ...
                <input type="text" id="numHoja" required name="numHoja" value="${numero_hoja1}" readonly/>
...
<script>
    jQuery(document).ready(function() {
        ...
        if ("${hora_consulta1}" != '/N' ) {
            $("#horaCons").val("${hora_consulta1}" );
        }else{
            $("#horaCons").val('/N' );
        }
        if ("${numero_hoja1}" != '/N' ) {
            $("#numHoja").val("${numero_hoja1}" );
        }else{
            $("#numHoja").val('/N' );
        }
        if ("${peso_kg1}" != '/N' ) {
        ...
        if ("${hora_inicio_consulta1}" != '/N' ) {
            $("#horaIniCons").val("${hora_inicio_consulta1}" );
        }else{
            $("#horaIniCons").val('/N' );
        }
        if ("${consulta1}" != '/N' ) {
            $("#tipoConsulta").val("${consulta1}" );
            $('#tipoConsulta').change();
        }else{
            $("#tipoConsulta").val('/N' );
            $('#tipoConsulta').change();
        }
        if ("${lugar_atencion1}" != '/N' ) {
            $('#lugarConsulta').val("${lugar_atencion1}");
            $('#lugarConsulta').change();
        }else{
            $('#lugarConsulta').val('/N');
            $('#lugarConsulta').change();
        }
        if ("${presion_medico1}" != '/N' ) {
            $("#paMedico").val("${presion_medico1}" );
        }else{
            $("#paMedico").val('/N' );
        }
        if ("${temperatura_medico1}" != '/N' ) {
            $("#tempMedico").val("${temperatura_medico1}" );
        }else{
            $("#tempMedico").val('/N' );
        }
        if ("${fcia_resp1}" != '/N' ) {
            $("#frMedico").val("${fcia_resp1}" );
        }else{
            $("#frMedico").val('/N' );
        }
        if ("${fcia_card_medico1}" != '/N' ) {
            $("#fcMedico").val("${fcia_card_medico1}" );
        }else{
            $("#fcMedico").val('/N' );
        }
        if ("${saturaciono2_medico1}" != '/N' ) {
            $("#soMedico").val("${saturaciono2_medico1}" );
        }else{
            $("#soMedico").val('/N' );
        }
        if ("${fis1}" != '/N' ) {
        ...
        if ("${ult_dia_fiebre1}" != '/N' ) {
            $("#ultimoDiaFiebre").val("${ult_dia_fiebre1}" );
            $('#ultimoDiaFiebre').change();
        }else{
            $("#ultimoDiaFiebre").val('/N' );
            $('#ultimoDiaFiebre').change();
        }
        if ("${hora_ult_dia_fiebre1}" != '/N' ) {
            $("#horaUltimoDiaF").val("${hora_ult_dia_fiebre1}" );
            $('#horaUltimoDiaF').change();
        }else{
            $("#horaUltimoDiaF").val('/N' );
            $('#horaUltimoDiaF').change();
        }
        if ("${ult_dosis_antipiretico1}" != '/N' ) {
            $("#ultimaDosisAntip").val("${ult_dosis_antipiretico1}" );
            $('#ultimaDosisAntip').change();
        }else{
            $("#ultimaDosisAntip").val('/N' );
            $('#ultimaDosisAntip').change();
        }
        if ("${hora_ult_dosis_antipiretico1}" != '/N' ) {
            $("#horaUltimaDosisAntip").val("${hora_ult_dosis_antipiretico1}" );
        }else{
            $("#horaUltimaDosisAntip").val('/N' );
        }
        if ("${hora_ult_dosis_antipiretico1}" != '/N' ) {
            $("#horaUltimaDosisAntip").val("${hora_ult_dosis_antipiretico1}" );
        }else{
       ...
       //llena check box de sintomas
        ...
        if ("${numeroVomito12h1}" != '/N') {
            $("#numVomito").val("${numeroVomito12h1}");
        }
        if ("${diarrea1}" === 'S') {
        ...
        if ("${bajoPesoSevero1}" === 'S') {
            $("#rbestadonut_7S").prop('checked', true);
        }else{
            $("#rbestadonut_7N").prop('checked', true);
        }
        /*categoria*/
        if ("${categoria1}" != '/N') {
        ...
        if ("${cambioCategoria1}" != '/N') {
            $("#cambioCategoria").val("${cambioCategoria1}");
            $('#cambioCategoria').change();
        }
        /*Manifestaciones hemorrágicas*/
        if ("${pruebaTorniquetePositiva1}" === 'S') {
        ...
        if ("${hospitalizado1}" != '/N') {
            $("#hospitalizado").val("${hospitalizado1}");
            $('#hospitalizado').change();
        }
        if ("${hospitalizadoEspecificar1}" != '/N') {
            $("#unidadSaludHosp").val("${hospitalizadoEspecificar1}");
        }
        if ("${transfusionSangre1}" != '/N') {
            $("#transfusion").val("${transfusionSangre1}");
            $('#transfusion').change();
        }
        if ("${transfusionEspecificar1}" != '/N') {
            $("#transfusionEsp").val("${transfusionEspecificar1}");
        }
        if ("${tomandoMedicamento1}" != '/N') {
            $("#tomaMedicamento").val("${tomandoMedicamento1}");
            $('#tomaMedicamento').change();
        }
        if ("${medicamentoEspecificar1}" != '/N') {
            $("#cualMedicamento").val("${medicamentoEspecificar1}");
        }
        ...
        if ("${otroExamanLabEspecificar1}" != '/N') {
            $("#descOtroExamen").val("${otroExamanLabEspecificar1}");
        }
        /*Tratamiento*/
        if ("${acetaminofen1}" === 'S') {
        ...
        if ("${historiaClinica1}" != '/N') {
            $("#historia").val("${historiaClinica1}");
        }
        if ("${diagnostico1}" != '/N') {
            $("#dx").val("${diagnostico1}");
            $('#dx').change();
        ...
        if ("${diagnostico11}" != '/N') {
            $("#diagnostico1").val("${diagnostico11}");
            $('#diagnostico1').change();
        }
        if ("${diagnostico21}" != '/N') {
            $("#diagnostico2").val("${diagnostico21}");
            $('#diagnostico2').change();
        }
        if ("${diagnostico31}" != '/N') {
            $("#diagnostico3").val("${diagnostico31}");
            $('#diagnostico3').change();
        }
        if ("${diagnostico41}" != '/N') {
            $("#diagnostico4").val("${diagnostico41}");
            $('#diagnostico4').change();
        }
        /*fin de llenado de  checkbox*/
        /*Cierre*/
        if ("${telefonoEmergencia1}" != '/N') {
            $("#telefono").val("${telefonoEmergencia1}");
        }
        if ("${proximaCita1}" != '/N') {
            $("#cita").val("${proximaCita1}");
        }
        if ("${medico1}" != '/N') {
            $("#medico").val("${medico1}");
            $('#medico').change();
        ...
        if ("${fechaMedico1}" != '/N') {
            $("#fechaMedico").val("${fechaMedico1}");
            $('#fechaMedico').change();
        }
        if ("${horaMedico1}" != '/N') {
            $("#horaMedico").val("${horaMedico1}");
        }
        if ("${enfermeria1}" != '/N') {
            $("#enfermeria").val("${enfermeria1}");
            $('#enfermeria').change();
        }
        if ("${fechaEnfermeria1}" != '/N') {
            $("#fechaEnfermeria").val("${fechaEnfermeria1}");
            $('#fechaEnfermeria').change();
        }
        if ("${horaEnfermeria1}" != '/N') {
            $("#horaEnfermeria").val("${horaEnfermeria1}");
        }
