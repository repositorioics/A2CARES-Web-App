    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/hojaclinica/" htmlEscape="true "/>"><spring:message code="clinical_sheet" /></a>
            </li>
        </ol>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="page-title">
                        <spring:message code="clinical_sheet" /> <small><spring:message code="search" /></small>
                    </h3>
                </div>
