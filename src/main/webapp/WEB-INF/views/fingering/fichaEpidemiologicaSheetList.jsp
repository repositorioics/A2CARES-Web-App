    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i> <a href="<spring:url value="/fichaEpidemiologica/" htmlEscape="true "/>"><spring:message code="fichaEpidemiologica_sheet" /></a>
            </li>
        </ol>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="page-title">
                        <spring:message code="fichaEpidemiologica_sheet" /> <small><spring:message code="search" /></small>
                    </h3>
                </div>
                <div class="card-block">
                    <div class="row table-toolbar">
                        <div class="col-md-12">
                            <div class="btn-group">
                                <spring:url value="/fichaEpidemiologica/add/" var="nuevaHoja"/>
...
<spring:url value="/hojaclinica/get" var="sHojasUrl"/>
